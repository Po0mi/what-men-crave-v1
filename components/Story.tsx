"use client";
import { useStoryAnimation } from "@/hooks/useStoryAnimation"; // Adjust path as needed
import "./Story.scss";

const Story = () => {
  const { containerRef } = useStoryAnimation();
    ...
    <section className="story">
      ...
      <div className="story-container" ref={containerRef}>
        ...
        <div className="story-body">
          ...
          <p>
            Most women live in this gap. They wonder if they&apos;re
            &ldquo;doing it right.&rdquo; They worry they&apos;re too demanding
            or not enough. They assume men are simple, or that silence means
            satisfaction.
          </p>
          ...
          <p>
            After coaching over 100,000 women and having more honest, unfiltered
            conversations about sex and intimacy than 99% of men ever will, I
          ...
          <p>
            But they are afraid to ask. Afraid of judgment. Afraid of rejection.
            So they stay quiet. And you are left guessing.
          </p>
