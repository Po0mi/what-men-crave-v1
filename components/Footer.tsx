  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        <p className="footer-name">Mat Shaffer</p>
        ...
        <div className="footer-contact">
          <p className="footer-contact-label">Let&rsquo;s Get In Touch</p>
          <a href="mailto:support@matshaffer.com" className="footer-contact-email">
        ...
        <p className="footer-tagline">
          Mat Shaffer &mdash; Connection, Empowerment &amp; Relationship Coach
        </p>
        <p className="footer-copy">
          &copy; {year} Mat Shaffer. All rights reserved.
        </p>
      </div>
    </footer>
  );
